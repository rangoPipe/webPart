              ...
              <div className="ms-Grid">
                <div className="ms-Grid-row section">
                    <div className="ms-Grid-col ms-sm12 ms-md12 ms-lg12">
                        <SubspaceProvider mapState={(state: IIOIPStore) => { return { messageBar: state.messageBar }; }} >
                            <MessageBar />
                        </SubspaceProvider>                   
                    </div>
                ...
                <div className="ms-Grid-col ms-sm12 ms-md4 ms-lg6 ms-mdPush8">
                  <Stack horizontal>
                      <Button button = { { text : "Renovar", buttonStyle: ButtonStyle.PrimaryButton, onClick : onAccept }} />
