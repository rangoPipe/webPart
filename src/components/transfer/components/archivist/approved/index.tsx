...
import { IApprovedProps, IApprovedState } from "./IApprovedProps";
import { ApprovedNameSpace } from "../../../../../enum/archivist/archivistEnum";
...
class ApprovedClass extends React.Component<IApprovedProps, IApprovedState>  {
   ...
   * @param {ApiRecordItem[]} items Listado de items
   * @private
   */
...
const mapStateToProps = (state: IIOIPStore) => {
   ...
   */
  export default connect(mapStateToProps)(ApprovedClass);
